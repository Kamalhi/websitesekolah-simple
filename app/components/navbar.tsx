...
const Navbar = () => {
  ...
  return (
    <main className="flex flex-col w-full">
      ...
      <nav className="bg-[#D4D4D4] w-full h-[80px] flex items-center p-10 justify-between">
        <h1 className="text-center uppercase text-[2rem] font-extrabold">
        ...
        <ul ref={dropDownRef} className="flex gap-12 items-center">
          ...
          <li className="relative group">
            <button
              className="md:text-[16px] text-[12px] flex justify-between gap-3 hover:cursor-pointer items-center"
              onClick={() => setOpen(open === "informasi" ? null : "informasi")}
            >
              Informasi
              <svg
                xmlns="http://www.w3.org/2000/svg"
